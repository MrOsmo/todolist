...
const changeStatusButton = document.querySelector(".deleteAll button:last-child");

if (changeStatusButton) {
    changeStatusButton.addEventListener("click", changeStatusOfAll);
}
